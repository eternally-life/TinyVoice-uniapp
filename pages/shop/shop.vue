<template>
	<view class="contact">
		<u-sticky><u-notice-bar :text="noticeTitle"></u-notice-bar></u-sticky>
		<view class="scroll">
			<!-- 左侧滚动区域 -->
			<scroll-view class="left" scroll-y>
				<view
					@click="btnColor(index, i.mallId)"
					:class="active === index ? 'active' : ''"
					v-for="(i, index) in commodityCate"
					:key="i.mallId"
				>
					{{ i.name }}
				</view>
			...
			<scroll-view class="right" scroll-y>
				<view class="rightItem">
					...
					<view class="empty" v-if="!commodityList.length">
