<template>
	<view class="profile_wrap">
		...
		<view class="topInfo">
			<view class="userInfo" @click="toLogin">
				<view class="user_avator">
					<image
						:src="wxUserInfo.avatar ? wxUserInfo.avatar : 'https://tiny-voice.oss-cn-guangzhou.aliyuncs.com/logo/QQ%E5%9B%BE%E7%89%8720211101001355.jpg'"
						class="userAvatar" />
				</view>
				<view class="right">
					<view class="user">
		...
		<view class="botInfo">
			<button class="setItem" v-for="(item, index) in setInfo" :open-type="item.open_type" @tap="toDetail(index)"
				:key="index">
				<view class="setIcon">
		...
		<u-modal :show="showSignExplain" :title="noticeTitle" @confirm="showSignExplain = false" confirmColor="#2979ff"
			closeOnClickOverlay @close="showSignExplain = false">
