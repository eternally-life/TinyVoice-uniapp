<template>
	<view class="profile_wrap">
		...
		<view class="botInfo">
			<button class="setItem" v-for="(item, index) in setInfo" :open-type="item.open_type"
				@click="toDetail(item.name)" :key="index">
				<view class="setIcon">
...
<script>
	...
	import {
		systemSyssignPage_Get,
		systemSyssignSave_Post
	} from '@/api/SYSTEM/签到.js';
	import {
	...
	import {
		tabbar_hid
	} from '@/components/mixins/tabbar.js';
	export default {
		mixins: [tabbar_hid],
		data() {
			return {
