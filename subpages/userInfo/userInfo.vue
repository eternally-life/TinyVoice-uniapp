...
<<<<<<< HEAD
		...
		<view  class="">
=======
		<view class="avatar"><u-avatar :src="showAvatarUrl" size="90" @click="selectImg"></u-avatar></view>
		<view v-if="audit == 'false'" class="">
>>>>>>> 428026ed11d822715e2f15ae59d424a0057c669c
			<u-cell-group>
				<u-cell
...
<script>
import { systemTinyuserUpdateUser_Post } from '@/api/SYSTEM/用户信息.js';
